<?php
    ...
    $query="select product_id, name, information, price, amount, branch_name,image from product inner join branch on product.branch_code = branch.branch_code where type_product ='$request'";
