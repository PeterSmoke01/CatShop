...
<body>
    ...
    <header>
        ...
        <ul class="navbar">
            ...
            <li><a href="product.php">By Type</a></li>
    ...
    <div class="col" style="top: 200px; padding: 50px;" >
      <input type="text" class="form-control" placeholder="ค้นหาข้อมูลบริการ" id="myInput" onkeyup="myFunction()">
    </div>
